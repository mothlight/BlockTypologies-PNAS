...
Data and knowledge about how cities work are needed to minimise the negative impacts of the urbanisation process on residents and to maximise the benefits. Understanding how urban form impacts performance of cities with respect to elements such as air pollution, infrastructure, and urban heat first requires a method to identify neighbourhoods and perform intra-city comparisons. Our method uses block size and regularity derived from maps to find the distribution and composition of neighbourhood types across global cities. This approach allows identification of the characteristics and mixes of neighbourhoods in cities, an individual `fingerprint', enabling lessons learned from high-performing cities to be applied across the world.}
